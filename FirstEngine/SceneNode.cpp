...
SceneNode::SceneNode(unsigned int actorId, BaseRenderComponent* renderComponent, RenderPass renderPass, const DirectX::XMFLOAT4X4* to, const DirectX::XMFLOAT4X4* from) {
	...
	m_Props = std::shared_ptr<SceneNodeProperties>(new SceneNodeProperties());
