...
public:
    ...
    std::shared_ptr<Actor> CreateActor(const char* actorResource, TiXmlElement* overrides, const DirectX::XMMATRIX* initialTransform, const unsigned int serversActorId);
